...
CREATE TABLE SMS_TR_HOTEL_TRACKER (ID BIGSERIAL NOT NULL,HT_CODE VARCHAR(255),HT_BRANCH_ID bigint,HT_HOTEL_ID bigint,HT_HOTEL_HR_ID bigint,HT_STUDENT_ID bigint, HT_DURATION_TO Date,HT_DURATION_FROM Date,HT_CREATED_DATE Date,HT_MODIFIED_DATE Date,HT_STATUS VARCHAR(255),HT_REMARKS VARCHAR(255),PRIMARY KEY (ID));
--STUDENT ATTANDANCE
CREATE TABLE SMS_TR_STUDENT_ATTENDANCE(	ID bigint ,STA_ATTENDANCE_DATE DATE NOT NULL,STA_USER_ID BIGINT NOT NULL,STA_BRANCH_ID BIGINT NOT NULL,STA_COURSE_ID BIGINT NOT NULL,STA_CREATION_DATE DATE,STA_MODIFICATION_DATE DATE,STA_BATCH BIGINT NOT NULL,PRIMARY KEY (ID));
