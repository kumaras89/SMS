...
CREATE TABLE SMS_TR_MARKETING_COMMISSION_SPLIT(ID  BIGSERIAL NOT NULL, MCS_STUDENT_ID INT8,MCS_MARKETING_EMPLOYEE_ID INT8,AMOUNT numeric(16,2),PRIMARY KEY (ID));
