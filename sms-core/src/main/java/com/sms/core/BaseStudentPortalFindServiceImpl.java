...
@Service
public abstract class BaseStudentPortalFindServiceImpl<T> implements IStudentPortalService<T> {

    private final JpaRepository<T, Long> jpaRepository;

    public BaseStudentPortalFindServiceImpl(JpaRepository<T, Long> jpaRepository) {
